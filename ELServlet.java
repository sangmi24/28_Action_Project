...
public class ELServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		 ...
		 * 1. ServletContenxt (application scope)
		 ...
		 *  이 영역에 데이터를 담으면 해당 request 객체를 포워딩 받는 응답 jsp 에서만 사용가능 (1회성 사이클)
		 ...
		 *        값을 꺼내고자 할 때는 : 객체명.getAttribute("키"); => Object 타입의 밸류
		...
		request.setAttribute("student", new Person("오상미", 23, "여자"));
		...
		// requestScope 와 sessionScope 에 동일한 키값으로도 데이터 담기
